...
function validadeNewIfExistNote() {
  let values = JSON.parse(localStorage.getItem(localStorageKey) || "[]")
  let inputValue = document.getElementById('input-new-note').value
  let exists = values.find(x => x.name == inputValue)
  return !exists ? false : true
}

function newTask() {
  let input = document.getElementById('input-new-note')
  input.style.border = ''
  ...
  } else if(validadeNewIfExistNote()){
